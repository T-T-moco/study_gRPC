...
type UploadRequest struct {
	...
	Data []byte `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"` // データ
}
...
type UploadResponse struct {
	...
	Size int32 `protobuf:"varint,1,opt,name=size,proto3" json:"size,omitempty"` // 受け取ったデータのサイズ
}
